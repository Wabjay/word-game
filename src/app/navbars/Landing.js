                            ...
                            isSmallScreen ? <>
                                ...
                                <div className="flex font-medium flex-row items-center gap-[50px] desktop:gap-[134px]">
                                    ...
                                    <ul className="flex font-medium flex-row items-center gap-6 desktop:gap-9">
                                        <li className=""> <Link smooth href='/#works' className="text-[##636363] text-[14px] font-medium">How our game works</Link> </li>
                                        <li className=""> <Link smooth href='/#presentation' className="text-[##636363] text-[14px] font-medium">Point and credit Rewards</Link> </li>
                                        <li className="">  <Link href='/blog' className="text-[##636363] text-[14px] font-medium">Leaderboard System</Link> </li>
                                    </ul>
